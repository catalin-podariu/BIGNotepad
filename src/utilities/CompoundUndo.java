 ...
 **  by Rob Camick on October 27, 2008
 */
public class CompoundUndo extends UndoManager
    ...
    public CompoundUndo(BIGNotepad pad) {
        this.pad = pad;
        textComponent = this.pad.bigEdit;
        this.pad.undoManager = new UndoManager();
