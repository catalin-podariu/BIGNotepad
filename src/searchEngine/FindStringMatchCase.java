...
public class FindStringMatchCase extends FindString {
    ...
    // private constructor
    private FindStringMatchCase(JTextPane notepad, String toFind, String match) {
    ...
    // static factory
    public static FindStringMatchCase getSearch(JTextPane notepad, String toFind, String match) {
