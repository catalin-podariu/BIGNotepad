...
public class FastReader extends BIGNotepad {
    ...
    private FastReader(BIGNotepad pad) {
        this.pad = pad;
     ...
     * *.exe file would have) it will take a long time to open.
     * <br>
     * If the document exceeds 1Mb, it will also take a lot to read/display. But
     * fastReader uses a MappedByteBuffer that makes things a lot faster!
     * <br>
     *
     * @param textFile text file to open (path)
     ...
     * fileChannel size. Basically the file size.
     * <br>
     *
     * @param position offset in the fileChannel. This offset + the chunk length
     ...
     * Default is 4096 bytes. This should be greater for files larger than a few
     * megabytes.
     */
