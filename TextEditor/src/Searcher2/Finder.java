...
public class Finder {
    ...
    // private constructor
    protected Finder(JTextPane notepad, String toFind, String match) {
        this.match = match;
    ...
    // static factory
    public static Finder getSearch(JTextPane notepad, String toFind, String match) {
        return new Finder(notepad, toFind, match);
    }
